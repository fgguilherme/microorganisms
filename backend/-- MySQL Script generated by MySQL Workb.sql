...
CREATE TABLE IF NOT EXISTS `micro_collection`.`reino` (
  ...
  UNIQUE INDEX `reino_UNIQUE` (`reino` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`filo` (
  ...
  UNIQUE INDEX `filo_UNIQUE` (`filo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`especie` (
  ...
  UNIQUE INDEX `especie_UNIQUE` (`especie` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`sub_especie` (
  ...
  UNIQUE INDEX `sub_especie_UNIQUE` (`sub_especie` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`variedade` (
  ...
  UNIQUE INDEX `variedade_UNIQUE` (`variedade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`cor` (
  ...
  UNIQUE INDEX `cor_UNIQUE` (`cor` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`textura` (
  ...
  UNIQUE INDEX `textura_UNIQUE` (`textura` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`borda` (
  ...
  UNIQUE INDEX `borda_UNIQUE` (`borda` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`relevo` (
  ...
  UNIQUE INDEX `relevo_UNIQUE` (`relevo` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`exudato` (
  ...
  UNIQUE INDEX `exudato_UNIQUE` (`exudato` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`pigmento` (
  ...
  UNIQUE INDEX `pigmento_UNIQUE` (`pigmento` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`laboratorio` (
  ...
  UNIQUE INDEX `laboratorio_UNIQUE` (`laboratorio` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`sub_colecao` (
  ...
  UNIQUE INDEX `sub_colecao_UNIQUE` (`sub_colecao` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`microorganismo` (
  ...
  `referencia_taxa` INT UNSIGNED NOT NULL,
  ...
  `referencia_temp` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_microorganismo_referencia1_idx` (`referencia_taxa` ASC) VISIBLE,
  ...
  INDEX `fk_microorganismo_pesquisador4_idx` (`pesquisador_preserv` ASC) VISIBLE,
  ...
  INDEX `fk_microorganismo_referencia2_idx` (`referencia_temp` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_microorganismo_variedade1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_microorganismo_referencia1`
    FOREIGN KEY (`referencia_taxa`)
  ...
  CONSTRAINT `fk_microorganismo_pesquisador3`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_microorganismo_pesquisador4`
  ...
  CONSTRAINT `fk_microorganismo_cor3`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_microorganismo_referencia2`
    FOREIGN KEY (`referencia_temp`)
    REFERENCES `micro_collection`.`referencia` (`idreferencia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `micro_collection`.`microorganismo_has_metodo_preservacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `micro_collection`.`microorganismo_has_metodo_preservacao` (
  `microorganismo_idmicroorganismo` INT UNSIGNED NOT NULL,
  `metodo_preservacao_idmetodo_preservacao` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`microorganismo_idmicroorganismo`, `metodo_preservacao_idmetodo_preservacao`),
  INDEX `fk_microorganismo_has_metodo_preservacao_metodo_preservacao_idx` (`metodo_preservacao_idmetodo_preservacao` ASC) VISIBLE,
  INDEX `fk_microorganismo_has_metodo_preservacao_microorganismo1_idx` (`microorganismo_idmicroorganismo` ASC) VISIBLE,
  CONSTRAINT `fk_microorganismo_has_metodo_preservacao_microorganismo1`
    FOREIGN KEY (`microorganismo_idmicroorganismo`)
    REFERENCES `micro_collection`.`microorganismo` (`idmicroorganismo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_microorganismo_has_metodo_preservacao_metodo_preservacao1`
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`microorganismo_has_carac_micromorfologica` (
  ...
  PRIMARY KEY (`microorganismo_idmicroorganismo`, `carac_micromorfologica_idcarac_micromorfologica`),
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`microorganismo_has_imagem_macro` (
  ...
  PRIMARY KEY (`microorganismo_idmicroorganismo`, `imagem_idimagem`),
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`microorganismo_has_anexos` (
  ...
  PRIMARY KEY (`microorganismo_idmicroorganismo`, `anexos_idanexos`),
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`unidade` (
  ...
  UNIQUE INDEX `unidade_UNIQUE` (`unidade` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`repique_has_referencia` (
  ...
  PRIMARY KEY (`repique_idrepique`, `referencia_idreferencia`),
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`repique_has_imagem` (
  `repique_idrepique` INT UNSIGNED NOT NULL,
  `imagem_idimagem` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`repique_idrepique`, `imagem_idimagem`),
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`repique_has_repique` (
  ...
  PRIMARY KEY (`repique_idrepique`, `repique_idrepique1`),
