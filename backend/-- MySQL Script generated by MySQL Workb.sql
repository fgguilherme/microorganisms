...
CREATE TABLE IF NOT EXISTS `micro_collection`.`microorganismo_has_metodo_preservacao` (
  `idmicroorganismo_has_metodo_preservacao` INT NOT NULL AUTO_INCREMENT,
  `microorganismo_idmicroorganismo` INT UNSIGNED NOT NULL,
  `metodo_preservacao_idmetodo_preservacao` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idmicroorganismo_has_metodo_preservacao`, `microorganismo_idmicroorganismo`, `metodo_preservacao_idmetodo_preservacao`),
