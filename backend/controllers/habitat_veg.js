...
const Element = db.models.habitat_veg;
const Op = db.Sequelize.Op;
// Create and Save a new Element
exports.create = (req, res) => {
  // Validate request
  if (!req.body.registro || !req.body.hospedeiro_idhospedeiro || !req.body.substrato_idsubstrato || !req.body.codigo || !req.body.herbario) {
    res.status(400).send({
