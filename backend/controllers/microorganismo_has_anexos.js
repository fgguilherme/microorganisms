...
const Element = db.models.microorganismo_has_anexos;
const Op = db.Sequelize.Op;
// Create and Save a new Element
exports.create = (req, res) => {
  // Validate request
  if (!req.body.microorganismo_idmicroorganismo || !req.body.anexos_idanexos) {
    res.status(400).send({
...
exports.update = (req, res) => {
    ...
    Element.update(req.body, {
      where: {idmicroorganismo_has_anexos: id }
    })
      .then(num => {
        if (num == 1) {
          res.send({
