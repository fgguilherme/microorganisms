...
const Element = db.models.microorganismo_has_imagem_micro;
const Op = db.Sequelize.Op;
// Create and Save a new Element
exports.create = (req, res) => {
  // Validate request
  if (!req.body.microorganismo_idmicroorganismo || !req.body.imagem_idimagem) {
    res.status(400).send({
...
exports.update = (req, res) => {
    ...
    Element.update(req.body, {
      where: {idmicroorganismo_has_imagem_micro: id }
    })
      .then(num => {
        if (num == 1) {
          res.send({
