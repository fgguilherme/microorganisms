...
CREATE TABLE IF NOT EXISTS `micro_collection`.`repique` (
  ...
  PRIMARY KEY (`idrepique`, `repique_idrepique`),
  ...
  INDEX `fk_repique_repique1_idx` (`repique_idrepique` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_repique_pesquisador1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_repique_repique1`
...
CREATE TABLE IF NOT EXISTS `micro_collection`.`repique_has_repique` (
  ...
  `repique_parent` INT UNSIGNED NOT NULL,
  `repique_current` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idrepique_has_repique`, `repique_parent`, `repique_current`),
  INDEX `fk_repique_has_repique_repique2_idx` (`repique_current` ASC) VISIBLE,
  INDEX `fk_repique_has_repique_repique1_idx` (`repique_parent` ASC) VISIBLE,
  CONSTRAINT `fk_repique_has_repique_repique1`
    FOREIGN KEY (`repique_parent`)
    REFERENCES `micro_collection`.`repique` (`idrepique`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_repique_has_repique_repique2`
    FOREIGN KEY (`repique_current`)
    REFERENCES `micro_collection`.`repique` (`idrepique`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
